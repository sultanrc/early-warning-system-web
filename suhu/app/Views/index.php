                    ...
                    <div class="col-a">
                        <div class="card" style="margin-top: 5px;">
                            ...
                            <div class="card-body" style="background: #eadcdc;">
                                <div class="form-check" style="margin-top: 5px;"><input class="form-check-input" type="checkbox" id="hide-col-1"><label class="form-check-label" for="hide-col-1">Temperature</label></div>
                                <div class="form-check"><input class="form-check-input" type="checkbox" id="hide-col-2"><label class="form-check-label" for="hide-col-2">Humidity</label></div>
                                <div class="form-check"><input class="form-check-input" type="checkbox" id="hide-col-3"><label class="form-check-label" for="hide-col-3">Fire anomaly</label></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <footer class="text-center">
            <div class="container text-muted py-4 py-lg-5">
                <ul class="list-inline">
                    <li class="list-inline-item me-4"><a class="link-secondary" href="https://www.petrochina.co.id/">Official Website</a></li>
                    <li class="list-inline-item me-4"><a class="link-secondary" href="https://www.instagram.com/petrochina_id">Instagram</a></li>
                </ul>
                <ul class="list-inline">
